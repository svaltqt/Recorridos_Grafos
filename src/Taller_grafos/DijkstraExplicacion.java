...
public class DijkstraExplicacion {
    ...
    private static void dijkstra(int[][] grafo, int src) {
        ...
        // Initialize all distances as INFINITE and verticeYaProcesado[] as false
        for (int i = 0; i < V; i++) {
        ...
        for (int count = 0; count < V-1; count++) {
            ...
            // Toma el vertice con la distancia minima del conjunto de vertices aun no procesados
    ...
    public static void main(String[] args) {
        ...
        // Se llama a la función Dijkstra con el grafo y el nodo de origen
        dijkstra(graph, 0);
    }
}
